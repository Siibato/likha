...
class StudentRecordsRepositoryImpl implements StudentRecordsRepository {
  ...
  ResultFuture<LearnerDetails?> getLearnerDetails({required String classId, required String studentId}) =>
      ops.getLearnerDetails(_localDataSource, _remoteDataSource, classId: classId, studentId: studentId);
  ...
  ResultFuture<List<AttendanceRecord>> getAttendance({required String classId, required String studentId, String? schoolYear}) =>
      ops.getAttendance(_localDataSource, _remoteDataSource, classId: classId, studentId: studentId, schoolYear: schoolYear);
  ...
  ResultFuture<List<CoreValuesRecord>> getCoreValues({required String classId, required String studentId, String? schoolYear}) =>
      ops.getCoreValues(_localDataSource, _remoteDataSource, classId: classId, studentId: studentId, schoolYear: schoolYear);
  ...
  ResultFuture<List<SchoolHistory>> getSchoolHistory({required String classId, required String studentId}) =>
      ops.getSchoolHistory(_localDataSource, _remoteDataSource, classId: classId, studentId: studentId);
  ...
  ResultFuture<List<PreviousSubject>> getPreviousSubjects({required String classId, required String studentId, String? schoolHistoryId}) =>
      ops.getPreviousSubjects(_localDataSource, _remoteDataSource, classId: classId, studentId: studentId, schoolHistoryId: schoolHistoryId);
  ...
  ResultFuture<List<PreviousAttendance>> getPreviousAttendance({required String classId, required String studentId, String? schoolHistoryId}) =>
      ops.getPreviousAttendance(_localDataSource, _remoteDataSource, classId: classId, studentId: studentId, schoolHistoryId: schoolHistoryId);
  ...
  ResultFuture<Sf10Response> getSf10({required String classId, required String studentId, bool skipBackgroundRefresh = false}) =>
      ops.getSf10(_gradingLocalDataSource, _remoteDataSource, classId: classId, studentId: studentId, skipBackgroundRefresh: skipBackgroundRefresh);
}
