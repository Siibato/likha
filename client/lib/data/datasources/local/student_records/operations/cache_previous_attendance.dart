...
Future<void> cachePreviousAttendance(
  LocalDatabase localDatabase,
  List<PreviousAttendanceModel> records, {
  Transaction? txn,
}) async {
  try {
    ...
    Future<void> doUpsert(dynamic executor) async {
      for (final record in records) {
        ...
        if (updated == 0) {
          await executor.insert(DbTables.previousSchoolAttendance, map);
        }
      }
    }
    ...
    throw CacheException('Failed to cache previous attendance: $e');
  }
}
