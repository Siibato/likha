...
class AssignmentModel extends Assignment {
  ...
  const AssignmentModel({
    ...
    super.allowsTextSubmission = true,
    super.allowsFileSubmission = false,
  ...
  factory AssignmentModel.fromJson(Map<String, dynamic> json) {
    return AssignmentModel(
      ...
      allowsTextSubmission: _parseBool(json['allows_text_submission']),
      allowsFileSubmission: _parseBool(json['allows_file_submission']),
  ...
  factory AssignmentModel.fromMap(Map<String, dynamic> map) {
    return AssignmentModel(
      ...
      allowsTextSubmission: (map['allows_text_submission'] as int?) == 1,
      allowsFileSubmission: (map['allows_file_submission'] as int?) == 1,
      ...
      gradingPeriodNumber: (map['grading_period_number'] as num?)?.toInt(),
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'allows_text_submission': allowsTextSubmission ? 1 : 0,
      'allows_file_submission': allowsFileSubmission ? 1 : 0,
  ...
  Map<String, dynamic> toPayload() {
    return {
      ...
      'due_at': dueAt.toUtc().toIso8601String().replaceAll('Z', ''),
