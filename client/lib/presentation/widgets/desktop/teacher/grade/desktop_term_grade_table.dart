...
/// Desktop term grade table with inline QG editing and stats footer.
class DesktopTermGradeTable extends StatefulWidget {
  final List<Map<String, dynamic>> summary;
  final void Function(String studentId, int grade) onQgChanged;

  const DesktopTermGradeTable({
    super.key,
  ...
  @override
  State<DesktopTermGradeTable> createState() => _DesktopTermGradeTableState();
}

class _DesktopTermGradeTableState extends State<DesktopTermGradeTable> {
          ...
          Container(
            ...
            child: DataTable(
              ...
              columns: const [
                ...
                DataColumn(
                  label: Text('TG', style: TextStyle(fontWeight: FontWeight.w700)),
                  numeric: true,
                ),
                DataColumn(
