...
class GradeComponentSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final componentItems = items.where((i) {
      if (i.component == component) return true;
      ...
      if (component == 'term_assessment' && (i.component == 'qa' || i.component == 'term_assessment')) return true;
      ...
      if (component == 'qa' && (i.component == 'qa' || i.component == 'term_assessment')) return true;
      return false;
    }).toList();
