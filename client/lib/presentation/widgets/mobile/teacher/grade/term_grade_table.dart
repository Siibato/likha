...
/// Scrollable term grade table with inline QG editing.
///
/// Displays WW / PT / QA weighted scores, the editable Term Grade column,
/// and a descriptor badge. Manages its own editing state internally and
/// surfaces committed changes via [onQgChanged].
class TermGradeTable extends StatefulWidget {
  ...
  @override
  State<TermGradeTable> createState() => _TermGradeTableState();
}

class _TermGradeTableState extends State<TermGradeTable> {
