...
class _MaterialDetailPageState
    extends ConsumerState<MaterialDetailPage> {
  @override
  void initState() {
    super.initState();
  ...
  void _showEditDialog() {
    ...
    showDialog(
      context: context,
      builder: (_) => _EditMaterialDialogPage(
...
class _EditMaterialDialogPage extends ConsumerStatefulWidget {
  final String materialId;
  final String initialTitle;
  final String? initialContent;

  const _EditMaterialDialogPage({
  ...
  @override
  ConsumerState<_EditMaterialDialogPage> createState() =>
      _EditMaterialDialogPageState();
}

class _EditMaterialDialogPageState
    extends ConsumerState<_EditMaterialDialogPage> {
