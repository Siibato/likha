...
class AdminClassDetailPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AdminClassDetailPage> createState() =>
      _AdminClassDetailPageState();
}

class _AdminClassDetailPageState
    extends ConsumerState<AdminClassDetailPage> {
  int _currentPage = 0;
                    ...
                    children: [
                      ...
                      FilledButton.icon(
                        onPressed: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => AdminManageEnrollmentPage(
