            ...
            questions: vec![
                ...
                QuestionSpec {
                    ...
                    answer_key: AnswerKeySpec {
                        acceptable_answers: vec!["B".into(), "Option B".into()],
                    },
                },
                ...
                QuestionSpec {
                    ...
                    answer_key: AnswerKeySpec {
                        acceptable_answers: vec!["C".into(), "Option C".into()],
                    },
                },
                ...
                QuestionSpec {
                    ...
                    choices: vec![],
                    answer_key: AnswerKeySpec {
                        acceptable_answers: vec!["42".into(), "42-variant".into()],
                    },
                },
                ...
                QuestionSpec {
                    ...
                    choices: vec![],
                    answer_key: AnswerKeySpec {
                        acceptable_answers: vec!["principle".into(), "principle-variant".into()],
                    },
                },
        ...
        AssessmentSpec {
            ...
            questions: vec![
                QuestionSpec {
                    ...
                    answer_key: AnswerKeySpec {
                        acceptable_answers: vec!["B".into()],
                    },
                },
                QuestionSpec {
                    id: Q_MATH_T2_2,
                    question_type: "multiple_choice".into(),
                    text: "Open quiz Q2".into(),
                    points: 2,
                    order: 1,
                    is_multi_select: false,
                    tos_competency_id: Some(COMP_MATH_2_ID),
                    ...
                    answer_key: AnswerKeySpec {
                        acceptable_answers: vec!["C".into()],
                    },
                },
                QuestionSpec {
                    id: Q_MATH_T2_3,
                    question_type: "identification".into(),
                    text: "Open quiz Q3".into(),
                    points: 1,
                    order: 2,
                    is_multi_select: false,
                    tos_competency_id: Some(COMP_MATH_1_ID),
                    ...
                    choices: vec![],
                    answer_key: AnswerKeySpec {
                        acceptable_answers: vec!["ans".into()],
                    },
                },
                QuestionSpec {
                    id: Q_MATH_T2_4,
                    question_type: "identification".into(),
                    text: "Open quiz Q4".into(),
                    points: 2,
                    order: 3,
                    is_multi_select: false,
                    tos_competency_id: Some(COMP_MATH_2_ID),
        ...
        AssessmentSpec {
            ...
            questions: vec![
                QuestionSpec {
                    id: Q_SCI_T1_1,
                    question_type: "multiple_choice".into(),
                    text: "Science Q1".into(),
                    points: 1,
                    order: 0,
                    is_multi_select: false,
                    tos_competency_id: Some(COMP_SCI_1_ID),
                    difficulty: Some("easy".into()),
                    cognitive_level: Some("remembering".into()),
                    choices: vec![
                        ChoiceSpec {
                ...
                QuestionSpec {
                    id: Q_SCI_T1_2,
                    question_type: "multiple_choice".into(),
                    text: "Science Q2".into(),
                    points: 2,
                    order: 1,
                    is_multi_select: false,
                    tos_competency_id: Some(COMP_SCI_2_ID),
                    difficulty: Some("medium".into()),
                    cognitive_level: Some("understanding".into()),
                    choices: vec![
                        ChoiceSpec {
                ...
                QuestionSpec {
                    id: Q_SCI_T1_5,
                    question_type: "essay".into(),
                    text: "Science Q5 (essay)".into(),
                    points: 5,
                    order: 4,
                    is_multi_select: false,
                    tos_competency_id: Some(COMP_SCI_3_ID),
                    difficulty: Some("hard".into()),
                    cognitive_level: Some("evaluating".into()),
                    choices: vec![],
                    answer_key: AnswerKeySpec {
...
pub fn e2e_assessment_submissions(ctx: &SeedContext) -> Vec<AssessmentSubmissionSpec> {
    ...
    vec![
        ...
        AssessmentSubmissionSpec {
            ...
            answers: vec![
                SubmissionAnswerSpec {
                    question_id: Q_MATH_T1_1,
                    choice_ids: vec![],
                    text: None,
                ...
                SubmissionAnswerSpec {
                    question_id: Q_MATH_T1_4,
                    choice_ids: vec![],
                    text: Some("principle".into()),
                    is_correct: Some(true),
                    points: 2.0,
                },
                SubmissionAnswerSpec {
                    question_id: Q_MATH_T1_5,
                    choice_ids: vec![],
                    text: None,
                    is_correct: None,
                    points: 0.0,
