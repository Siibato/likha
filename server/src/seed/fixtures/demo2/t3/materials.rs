//! T3 learning modules for demo-2: 2 subjects × 2 modules each (4 total).
...
pub fn demo2_materials_t3(ctx: &SeedContext) -> Vec<MaterialSpec> {
    ...
    // English 10: Academic Writing (disconnected from seed)
    // materials.push(MaterialSpec {
    //     id: mid("eng_t3_mod1"),
    //     class_id: cid("eng10"),
    ...
    // AP 10: Contemporary PH History (disconnected from seed)
    // materials.push(MaterialSpec {
    //     id: mid("ap_t3_mod1"),
    //     class_id: cid("ap10"),
    ...
    // Filipino 10: Sanaysay at Komunikasyon (disconnected from seed)
    // materials.push(MaterialSpec {
    //     id: mid("fil_t3_mod1"),
    //     class_id: cid("fil10"),
    ...
    // TLE 10: Entrepreneurship (disconnected from seed)
    // materials.push(MaterialSpec {
    //     id: mid("tle_t3_mod1"),
    //     class_id: cid("tle10"),
