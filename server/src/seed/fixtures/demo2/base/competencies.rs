...
pub fn demo2_competencies() -> Vec<CompetencySpec> {
    ...
    // English 10 - T1: Philippine Literature (disconnected from seed)
    ...
    // // English 10 - T2: World Literature (disconnected from seed)
    ...
    // // English 10 - T3: Academic Writing (disconnected from seed)
    ...
    // AP 10 - T1: Pre-colonial to Spanish Period (disconnected from seed)
    ...
    // // AP 10 - T2: Revolution & American Period (disconnected from seed)
    ...
    // // AP 10 - T3: Contemporary PH History (disconnected from seed)
    ...
    // Filipino 10 - T1: Maikling Kuwento (disconnected from seed)
    ...
    // // Filipino 10 - T2: Tula at Dula (disconnected from seed)
    ...
    // // Filipino 10 - T3: Sanaysay at Komunikasyon (disconnected from seed)
    ...
    // TLE 10 - T1: Computer Hardware Servicing (disconnected from seed)
    ...
    // // TLE 10 - T2: Cookery (disconnected from seed)
    ...
    // // TLE 10 - T3: Entrepreneurship (disconnected from seed)
