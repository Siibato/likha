//! Quarter 1 assessments for realistic seeding.
...
pub fn realistic_assessments_q1(ctx: &SeedContext) -> Vec<AssessmentSpec> {
    ...
    assessments.push(AssessmentSpec {
        ...
        questions: vec![
            QuestionSpec { id: qid("eng_quiz1", 0), question_type: "multiple_choice".into(),
                ...
                points: 1, order: 0, is_multi_select: false, tos_competency_id: Some(compid("e9q1_comp_2")),
            ...
            QuestionSpec { id: qid("eng_quiz1", 1), question_type: "multiple_choice".into(),
                ...
                points: 1, order: 1, is_multi_select: false, tos_competency_id: Some(compid("e9q1_comp_2")),
            ...
            QuestionSpec { id: qid("eng_quiz1", 2), question_type: "identification".into(),
                ...
                points: 1, order: 2, is_multi_select: false, tos_competency_id: Some(compid("e9q1_comp_1")),
    ...
    assessments.push(AssessmentSpec {
        ...
        questions: vec![
            QuestionSpec { id: qid("eng_quiz2", 0), question_type: "multiple_choice".into(),
                ...
                points: 1, order: 0, is_multi_select: false, tos_competency_id: Some(compid("e9q1_comp_3")),
                difficulty: Some("medium".into()), cognitive_level: Some("understanding".into()),
            ...
            QuestionSpec { id: qid("eng_quiz2", 3), question_type: "identification".into(),
                ...
                points: 1, order: 3, is_multi_select: false, tos_competency_id: Some(compid("e9q1_comp_1")),
                difficulty: Some("easy".into()), cognitive_level: Some("remembering".into()), choices: vec![],
    ...
    // English 9 - Q1 Quarter Exam
    let eng_q1_exam_qs = build_questions_from_bank("eng_q1_exam",
        &[
        ...
        &[compid("e9q1_comp_0"), compid("e9q1_comp_1"), compid("e9q1_comp_2"), compid("e9q1_comp_3")],
    );
    let eng_q1_exam_points: i32 = eng_q1_exam_qs.iter().map(|q| q.points).sum();
    assessments.push(AssessmentSpec {
        id: aid("eng_q1_exam"), class_id: cid("english_9a"),
        title: "Quarter 1 Exam: English 9".into(),
        description: Some("15-item quarterly assessment on Afro-Asian literature and text types.".into()),
        time_limit_minutes: 60, open_at: now - chrono::Duration::days(10), close_at: now - chrono::Duration::days(2),
        show_results_immediately: true, total_points: eng_q1_exam_points, component: "quarterly_assessment".into(),
        tos_id: tid("english_9a_tos_q1"), created_at: created, deleted_at: None,
        is_published: true, results_released: true, grading_period_number: 1,
    ...
    assessments.push(AssessmentSpec {
        ...
        questions: vec![
            ...
            QuestionSpec { id: qid("sci_quiz1", 3), question_type: "identification".into(),
                ...
                points: 1, order: 3, is_multi_select: false, tos_competency_id: Some(compid("s9q1_comp_1")),
    ...
    assessments.push(AssessmentSpec {
        ...
        questions: vec![
            QuestionSpec { id: qid("sci_quiz2", 0), question_type: "multiple_choice".into(),
                ...
                points: 1, order: 0, is_multi_select: false, tos_competency_id: Some(compid("s9q1_comp_2")),
                difficulty: Some("easy".into()), cognitive_level: Some("remembering".into()),
            ...
            QuestionSpec { id: qid("sci_quiz2", 1), question_type: "multiple_choice".into(),
                ...
                points: 1, order: 1, is_multi_select: false, tos_competency_id: Some(compid("s9q1_comp_3")),
                difficulty: Some("medium".into()), cognitive_level: Some("understanding".into()),
            ...
            QuestionSpec { id: qid("sci_quiz2", 2), question_type: "identification".into(),
                ...
                points: 1, order: 2, is_multi_select: false, tos_competency_id: Some(compid("s9q1_comp_2")),
                difficulty: Some("easy".into()), cognitive_level: Some("remembering".into()), choices: vec![],
            ...
            QuestionSpec { id: qid("sci_quiz2", 3), question_type: "identification".into(),
                ...
                points: 1, order: 3, is_multi_select: false, tos_competency_id: Some(compid("s9q1_comp_2")),
                difficulty: Some("easy".into()), cognitive_level: Some("remembering".into()), choices: vec![],
    ...
    // Science 9 - Q1 Quarter Exam
    let sci_q1_exam_qs = build_questions_from_bank("sci_q1_exam",
        &[
        ...
        &[compid("s9q1_comp_0"), compid("s9q1_comp_1"), compid("s9q1_comp_2"), compid("s9q1_comp_3")],
    );
    let sci_q1_exam_points: i32 = sci_q1_exam_qs.iter().map(|q| q.points).sum();
    assessments.push(AssessmentSpec {
        id: aid("sci_q1_exam"), class_id: cid("science_9a"),
        title: "Quarter 1 Exam: Science 9".into(),
        description: Some("15-item quarterly assessment on Earth science, genetics, and chemistry.".into()),
        time_limit_minutes: 60, open_at: now - chrono::Duration::days(10), close_at: now - chrono::Duration::days(2),
        show_results_immediately: true, total_points: sci_q1_exam_points, component: "quarterly_assessment".into(),
        tos_id: tid("science_9a_tos_q1"), created_at: created, deleted_at: None,
        is_published: true, results_released: true, grading_period_number: 1,
