//! Quarter 2 assignments for realistic seeding.
...
pub fn realistic_assignments_q2(ctx: &SeedContext) -> Vec<AssignmentSpec> {
    ...
    vec![
        AssignmentSpec {
            id: asid("eng_q2_assign1"), class_id: cid("english_9a"),
        ...
        AssignmentSpec {
            id: asid("eng_q2_assign2"), class_id: cid("english_9a"),
        ...
        AssignmentSpec {
            id: asid("sci_q2_assign1"), class_id: cid("science_9a"),
        ...
        AssignmentSpec {
            id: asid("sci_q2_assign2"), class_id: cid("science_9a"),
