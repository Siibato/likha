...
use super::super::shared::{PASSWORD_STUDENT, PASSWORD_TEACHER};
use super::{cid, compid, mid, tid, uid};
...
pub fn realistic_users(ctx: &SeedContext) -> Vec<UserSpec> {
    ...
    users.push(UserSpec {
        id: uid("jose.cruz"),
        username: "jose.cruz".into(),
        first_name: "Jose Antonio".into(),
        last_name: "Cruz".into(),
        role: "teacher".into(),
        password_hash: Some(bcrypt::hash(PASSWORD_TEACHER, 4).unwrap()),
        account_status: "active".into(),
...
pub fn realistic_classes(ctx: &SeedContext) -> Vec<ClassSpec> {
    ...
    vec![
        ClassSpec {
            id: cid("english_9a"),
            title: "English 9".into(),
            description: Some("Grade 9 English class".into()),
            grade_level: Some("9".into()),
            school_year: Some("2025-2026".into()),
            is_advisory: false,
            is_archived: false,
            created_at: created,
        ...
        ClassSpec {
            id: cid("science_9a"),
            title: "Science 9".into(),
            description: Some("Grade 9 Science class".into()),
            grade_level: Some("9".into()),
            school_year: Some("2025-2026".into()),
            is_advisory: false,
            is_archived: false,
        ...
        ClassSpec {
            id: cid("advisory_9a"),
            title: "Advisory 9-A".into(),
            description: Some("Grade 9 Advisory class".into()),
            grade_level: Some("9".into()),
            school_year: Some("2025-2026".into()),
            is_advisory: true,
            is_archived: false,
...
pub fn realistic_tos() -> Vec<TosSpec> {
    vec![
        // T1
        TosSpec {
            id: tid("english_9a_tos_t1"),
            class_id: cid("english_9a"),
            term_number: 1,
            title: "TOS for English 9 - T1".into(),
        ...
        TosSpec {
            id: tid("science_9a_tos_t1"),
            class_id: cid("science_9a"),
            term_number: 1,
            title: "TOS for Science 9 - T1".into(),
        ...
        TosSpec {
            id: tid("advisory_9a_tos_t1"),
            class_id: cid("advisory_9a"),
            term_number: 1,
            title: "TOS for Advisory 9-A - T1".into(),
            template_type: "difficulty".into(),
            total_items: 20,
            time_limit_unit: "days".into(),
            ww_percent: 50.0,
        ...
        // T2
        TosSpec {
            id: tid("english_9a_tos_t2"),
            class_id: cid("english_9a"),
            term_number: 2,
            title: "TOS for English 9 - T2".into(),
            template_type: "difficulty".into(),
            total_items: 50,
            time_limit_unit: "days".into(),
            ww_percent: 40.0,
        ...
        TosSpec {
            id: tid("science_9a_tos_t2"),
            class_id: cid("science_9a"),
            term_number: 2,
            title: "TOS for Science 9 - T2".into(),
            template_type: "bloom".into(),
            total_items: 50,
            time_limit_unit: "days".into(),
            ww_percent: 40.0,
        ...
        TosSpec {
            id: tid("advisory_9a_tos_t2"),
            class_id: cid("advisory_9a"),
            term_number: 2,
            title: "TOS for Advisory 9-A - T2".into(),
            template_type: "difficulty".into(),
            total_items: 20,
            time_limit_unit: "days".into(),
            ww_percent: 50.0,
        ...
        // T3
        TosSpec {
            id: tid("english_9a_tos_t3"),
            class_id: cid("english_9a"),
            term_number: 3,
            title: "TOS for English 9 - T3".into(),
            template_type: "difficulty".into(),
            total_items: 50,
            time_limit_unit: "days".into(),
            ww_percent: 40.0,
        ...
        TosSpec {
            id: tid("science_9a_tos_t3"),
            class_id: cid("science_9a"),
            term_number: 3,
            title: "TOS for Science 9 - T3".into(),
            template_type: "bloom".into(),
            total_items: 50,
            time_limit_unit: "days".into(),
            ww_percent: 40.0,
        ...
        TosSpec {
            id: tid("advisory_9a_tos_t3"),
            class_id: cid("advisory_9a"),
            term_number: 3,
            title: "TOS for Advisory 9-A - T3".into(),
            template_type: "difficulty".into(),
            total_items: 20,
            time_limit_unit: "days".into(),
            ww_percent: 50.0,
        ...
        // T4
        TosSpec {
            id: tid("english_9a_tos_t4"),
            class_id: cid("english_9a"),
            term_number: 4,
            title: "TOS for English 9 - T4".into(),
            template_type: "difficulty".into(),
            total_items: 50,
            time_limit_unit: "days".into(),
            ww_percent: 40.0,
        ...
        TosSpec {
            id: tid("science_9a_tos_t4"),
            class_id: cid("science_9a"),
            term_number: 4,
            title: "TOS for Science 9 - T4".into(),
            template_type: "bloom".into(),
            total_items: 50,
            time_limit_unit: "days".into(),
            ww_percent: 40.0,
        ...
        TosSpec {
            id: tid("advisory_9a_tos_t4"),
            class_id: cid("advisory_9a"),
            term_number: 4,
            title: "TOS for Advisory 9-A - T4".into(),
            template_type: "difficulty".into(),
            total_items: 20,
            time_limit_unit: "days".into(),
            ww_percent: 50.0,
...
pub fn realistic_competencies() -> Vec<CompetencySpec> {
    vec![
        // English 9 T1
        CompetencySpec {
            id: compid("e9t1_comp_0"),
            tos_id: tid("english_9a_tos_t1"),
            code: Some("E9PL-Ia-1".into()),
            text: "Listen to get information from oral texts".into(),
            time_units_taught: 5,
            order: 0,
        },
        CompetencySpec {
            id: compid("e9t1_comp_1"),
            tos_id: tid("english_9a_tos_t1"),
            code: Some("E9RC-Ib-2".into()),
            text: "Identify text types (narrative, expository, persuasive)".into(),
            time_units_taught: 5,
            order: 1,
        },
        CompetencySpec {
            id: compid("e9t1_comp_2"),
            tos_id: tid("english_9a_tos_t1"),
            code: Some("E9LT-Ic-3".into()),
            text: "Explain literary devices used in Afro-Asian literature".into(),
            time_units_taught: 5,
            order: 2,
        },
        CompetencySpec {
            id: compid("e9t1_comp_3"),
            tos_id: tid("english_9a_tos_t1"),
            code: Some("E9WC-Id-4".into()),
            text: "Write a persuasive essay with clear arguments".into(),
            time_units_taught: 5,
            order: 3,
        },
        // Science 9 T1
        CompetencySpec {
            id: compid("s9t1_comp_0"),
            tos_id: tid("science_9a_tos_t1"),
            code: Some("S9ES-Ia-1".into()),
            text: "Describe the internal structure of the Earth".into(),
            time_units_taught: 5,
            order: 0,
        },
        CompetencySpec {
            id: compid("s9t1_comp_1"),
            tos_id: tid("science_9a_tos_t1"),
            code: Some("S9ES-Ib-2".into()),
            text: "Explain the theory of plate tectonics".into(),
            time_units_taught: 5,
            order: 1,
        },
        CompetencySpec {
            id: compid("s9t1_comp_2"),
            tos_id: tid("science_9a_tos_t1"),
            code: Some("S9LT-Ic-3".into()),
            text: "Describe how genetic information is passed from parents to offspring".into(),
            time_units_taught: 5,
            order: 2,
        },
        CompetencySpec {
            id: compid("s9t1_comp_3"),
            tos_id: tid("science_9a_tos_t1"),
            code: Some("S9MT-Id-4".into()),
            text: "Explain how different factors affect the rate of chemical reactions".into(),
            time_units_taught: 5,
            order: 3,
        },
        // Advisory 9-A T1
        CompetencySpec {
            id: compid("a9t1_comp_0"),
            tos_id: tid("advisory_9a_tos_t1"),
            code: Some("AD9PH-Ia-1".into()),
            text: "Demonstrate positive personal health practices".into(),
            time_units_taught: 3,
            order: 0,
        },
        CompetencySpec {
            id: compid("a9t1_comp_1"),
            tos_id: tid("advisory_9a_tos_t1"),
            code: Some("AD9PH-Ib-1".into()),
            text: "Explain the dimensions of holistic health".into(),
            time_units_taught: 3,
            order: 1,
        },
        // English 9 T2
        CompetencySpec {
            id: compid("e9t2_comp_0"),
            tos_id: tid("english_9a_tos_t2"),
            code: Some("E9OC-IIa-1".into()),
            text: "Deliver a speech of introduction effectively".into(),
            time_units_taught: 5,
            order: 0,
        },
        CompetencySpec {
            id: compid("e9t2_comp_1"),
            tos_id: tid("english_9a_tos_t2"),
            code: Some("E9OC-IIb-2".into()),
            text: "Use modal verbs appropriately in sentences".into(),
            time_units_taught: 5,
            order: 1,
        },
        CompetencySpec {
            id: compid("e9t2_comp_2"),
            tos_id: tid("english_9a_tos_t2"),
            code: Some("E9OC-IIc-3".into()),
            text: "Convert direct speech to reported speech".into(),
            time_units_taught: 5,
            order: 2,
        },
        CompetencySpec {
            id: compid("e9t2_comp_3"),
            tos_id: tid("english_9a_tos_t2"),
            code: Some("E9WC-IId-4".into()),
            text: "Write a persuasive speech using rhetorical devices".into(),
            time_units_taught: 5,
            order: 3,
        },
        // Science 9 T2
        CompetencySpec {
            id: compid("s9t2_comp_0"),
            tos_id: tid("science_9a_tos_t2"),
            code: Some("S9ES-IIa-1".into()),
            text: "Describe the components of an ecosystem".into(),
            time_units_taught: 5,
            order: 0,
        },
        CompetencySpec {
            id: compid("s9t2_comp_1"),
            tos_id: tid("science_9a_tos_t2"),
            code: Some("S9ES-IIb-2".into()),
            text: "Explain energy transfer through trophic levels".into(),
            time_units_taught: 5,
            order: 1,
        },
        CompetencySpec {
            id: compid("s9t2_comp_2"),
            tos_id: tid("science_9a_tos_t2"),
            code: Some("S9LT-IIc-3".into()),
            text: "Explain natural selection and adaptation".into(),
            time_units_taught: 5,
            order: 2,
        },
        CompetencySpec {
            id: compid("s9t2_comp_3"),
            tos_id: tid("science_9a_tos_t2"),
            code: Some("S9MT-IId-4".into()),
            text: "Propose strategies to protect Philippine biodiversity".into(),
            time_units_taught: 5,
            order: 3,
        },
        // Advisory 9-A T2
        CompetencySpec {
            id: compid("a9t2_comp_0"),
            tos_id: tid("advisory_9a_tos_t2"),
            code: Some("AD9PH-IIa-1".into()),
            text: "Evaluate nutritional value of common foods".into(),
            time_units_taught: 3,
            order: 0,
        },
        CompetencySpec {
            id: compid("a9t2_comp_1"),
            tos_id: tid("advisory_9a_tos_t2"),
            code: Some("AD9PH-IIb-1".into()),
            text: "Identify the effects of substance abuse on health".into(),
            time_units_taught: 3,
            order: 1,
        },
        // English 9 T3
        CompetencySpec {
            id: compid("e9t3_comp_0"),
            tos_id: tid("english_9a_tos_t3"),
            code: Some("E9RS-IIIa-1".into()),
            text: "Conduct research using credible sources".into(),
            time_units_taught: 5,
            order: 0,
        },
        CompetencySpec {
            id: compid("e9t3_comp_1"),
            tos_id: tid("english_9a_tos_t3"),
            code: Some("E9RS-IIIb-2".into()),
            text: "Evaluate source credibility and bias".into(),
            time_units_taught: 5,
            order: 1,
        },
        CompetencySpec {
            id: compid("e9t3_comp_2"),
            tos_id: tid("english_9a_tos_t3"),
            code: Some("E9ML-IIIc-3".into()),
            text: "Analyze persuasive techniques in media messages".into(),
            time_units_taught: 5,
            order: 2,
        },
        CompetencySpec {
            id: compid("e9t3_comp_3"),
            tos_id: tid("english_9a_tos_t3"),
            code: Some("E9ML-IIId-4".into()),
            text: "Create a multimedia presentation for a target audience".into(),
            time_units_taught: 5,
            order: 3,
        },
        // Science 9 T3
        CompetencySpec {
            id: compid("s9t3_comp_0"),
            tos_id: tid("science_9a_tos_t3"),
            code: Some("S9FM-IIIa-1".into()),
            text: "Describe Newton's laws of motion".into(),
            time_units_taught: 5,
            order: 0,
        },
        CompetencySpec {
            id: compid("s9t3_comp_1"),
            tos_id: tid("science_9a_tos_t3"),
            code: Some("S9FM-IIIb-2".into()),
            text: "Calculate speed, velocity, and acceleration".into(),
            time_units_taught: 5,
            order: 1,
        },
        CompetencySpec {
            id: compid("s9t3_comp_2"),
            tos_id: tid("science_9a_tos_t3"),
            code: Some("S9WE-IIIc-3".into()),
            text: "Distinguish between kinetic and potential energy".into(),
            time_units_taught: 5,
            order: 2,
        },
        CompetencySpec {
            id: compid("s9t3_comp_3"),
            tos_id: tid("science_9a_tos_t3"),
            code: Some("S9WE-IIId-4".into()),
            text: "Apply the law of conservation of energy".into(),
            time_units_taught: 5,
            order: 3,
        },
        // Advisory 9-A T3
        CompetencySpec {
            id: compid("a9t3_comp_0"),
            tos_id: tid("advisory_9a_tos_t3"),
            code: Some("AD9SE-IIIa-1".into()),
            text: "Demonstrate assertiveness in peer situations".into(),
            time_units_taught: 3,
            order: 0,
        },
        CompetencySpec {
            id: compid("a9t3_comp_1"),
            tos_id: tid("advisory_9a_tos_t3"),
            code: Some("AD9SE-IIIb-1".into()),
            text: "Evaluate consequences of decisions on relationships".into(),
            time_units_taught: 3,
            order: 1,
        },
        // English 9 T4
        CompetencySpec {
            id: compid("e9t4_comp_0"),
            tos_id: tid("english_9a_tos_t4"),
            code: Some("E9CW-IVa-1".into()),
            text: "Use figurative language in creative writing".into(),
            time_units_taught: 5,
            order: 0,
        },
        CompetencySpec {
            id: compid("e9t4_comp_1"),
            tos_id: tid("english_9a_tos_t4"),
            code: Some("E9CW-IVb-2".into()),
            text: "Write a short story with clear plot structure".into(),
            time_units_taught: 5,
            order: 1,
        },
        CompetencySpec {
            id: compid("e9t4_comp_2"),
            tos_id: tid("english_9a_tos_t4"),
            code: Some("E9LC-IVc-3".into()),
            text: "Analyze a literary text using biographical criticism".into(),
            time_units_taught: 5,
            order: 2,
        },
        CompetencySpec {
            id: compid("e9t4_comp_3"),
            tos_id: tid("english_9a_tos_t4"),
            code: Some("E9LC-IVd-4".into()),
            text: "Write a critical review of a contemporary novel".into(),
            time_units_taught: 5,
            order: 3,
        },
        // Science 9 T4
        CompetencySpec {
            id: compid("s9t4_comp_0"),
            tos_id: tid("science_9a_tos_t4"),
            code: Some("S9EM-IVa-1".into()),
            text: "Describe the relationship between electricity and magnetism".into(),
            time_units_taught: 5,
            order: 0,
        },
        CompetencySpec {
            id: compid("s9t4_comp_1"),
            tos_id: tid("science_9a_tos_t4"),
            code: Some("S9EM-IVb-2".into()),
            text: "Compare series and parallel circuits".into(),
            time_units_taught: 5,
            order: 1,
        },
        CompetencySpec {
            id: compid("s9t4_comp_2"),
            tos_id: tid("science_9a_tos_t4"),
            code: Some("S9CC-IVc-3".into()),
            text: "Explain the greenhouse effect and its causes".into(),
            time_units_taught: 5,
            order: 2,
        },
        CompetencySpec {
            id: compid("s9t4_comp_3"),
            tos_id: tid("science_9a_tos_t4"),
            code: Some("S9CC-IVd-4".into()),
            text: "Propose solutions to mitigate climate change".into(),
            time_units_taught: 5,
            order: 3,
        },
        // Advisory 9-A T4
        CompetencySpec {
            id: compid("a9t4_comp_0"),
            tos_id: tid("advisory_9a_tos_t4"),
            code: Some("AD9CP-IVa-1".into()),
            text: "Develop a personal career plan based on skills and interests".into(),
            time_units_taught: 3,
            order: 0,
        },
        CompetencySpec {
            id: compid("a9t4_comp_1"),
            tos_id: tid("advisory_9a_tos_t4"),
            code: Some("AD9CP-IVb-1".into()),
            text: "Create a monthly budget and explain the importance of saving".into(),
            time_units_taught: 3,
            order: 1,
        },
    ]
