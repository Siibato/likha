...
// ─── Names ───────────────────────────────────────────────────────────────────
const STUDENT_DATA: [(&str, &str, &str); 30] = [
...
pub fn realistic_users(ctx: &SeedContext) -> Vec<UserSpec> {
    ...
    users.push(UserSpec {
        ...
        first_name: "Maria Elena".into(), last_name: "Reyes".into(), role: "teacher".into(),
    ...
    users.push(UserSpec {
        ...
        first_name: "Jose Antonio".into(), last_name: "Cruz".into(), role: "teacher".into(),
        password_hash: Some(bcrypt::hash(PASSWORD_TEACHER, 4).unwrap()),
        account_status: "active".into(), created_at: created, activated_at: Some(activated), deleted_at: None,
    });
    ...
    for &(uname, fname, lname) in &STUDENT_DATA {
        users.push(UserSpec {
            ...
            first_name: fname.into(), last_name: lname.into(), role: "student".into(),
