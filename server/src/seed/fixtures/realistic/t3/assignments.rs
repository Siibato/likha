//! Term 3 assignments for realistic seeding.
...
pub fn realistic_assignments_t3(ctx: &SeedContext) -> Vec<AssignmentSpec> {
    ...
    vec![
        AssignmentSpec {
            id: asid("eng_t3_assign1"), class_id: cid("english_9a"),
        ...
        AssignmentSpec {
            id: asid("eng_t3_assign2"), class_id: cid("english_9a"),
        ...
        AssignmentSpec {
            id: asid("sci_t3_assign1"), class_id: cid("science_9a"),
        ...
        AssignmentSpec {
            id: asid("sci_t3_assign2"), class_id: cid("science_9a"),
