...
pub fn realistic_assignments_t4(ctx: &SeedContext) -> Vec<AssignmentSpec> {
    ...
    vec![
        AssignmentSpec {
            id: asid("eng_t4_assign1"), class_id: cid("english_9a"),
            ...
            created_at: created, deleted_at: None, is_published: true, term_number: 4,
        },
        AssignmentSpec {
            id: asid("eng_t4_assign2"), class_id: cid("english_9a"),
        ...
        AssignmentSpec {
            id: asid("sci_t4_assign1"), class_id: cid("science_9a"),
        ...
        AssignmentSpec {
            id: asid("sci_t4_assign2"), class_id: cid("science_9a"),
