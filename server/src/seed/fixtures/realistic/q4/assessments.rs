//! Quarter 4 assessments for realistic seeding.
...
pub fn realistic_assessments_q4(ctx: &SeedContext) -> Vec<AssessmentSpec> {
    ...
    assessments.push(AssessmentSpec {
        id: aid("eng_q4_quiz1"), class_id: cid("english_9a"),
        ...
        questions: vec![
            QuestionSpec { id: qid("eng_q4_quiz1", 0), question_type: "multiple_choice".into(),
                ...
                choices: mc_choices("eng_q4_quiz1_q0", 1),
                answer_key: AnswerKeySpec { acceptable_answers: vec!["B".into()] }, },
            QuestionSpec { id: qid("eng_q4_quiz1", 1), question_type: "multiple_choice".into(),
                text: "What is the primary purpose of imagery in writing?".into(),
                points: 1, order: 1, is_multi_select: false, tos_competency_id: Some(compid("e9q4_comp_0")),
                difficulty: Some("medium".into()), cognitive_level: Some("understanding".into()),
                choices: mc_choices("eng_q4_quiz1_q1", 0),
                answer_key: AnswerKeySpec { acceptable_answers: vec!["A".into()] }, },
            QuestionSpec { id: qid("eng_q4_quiz1", 2), question_type: "identification".into(),
                text: "What is the term for giving human qualities to non-human things?".into(),
                points: 1, order: 2, is_multi_select: false, tos_competency_id: Some(compid("e9q4_comp_0")),
            ...
            QuestionSpec { id: qid("eng_q4_quiz1", 3), question_type: "identification".into(),
                text: "Which plot element introduces the characters and setting?".into(),
                points: 1, order: 3, is_multi_select: false, tos_competency_id: Some(compid("e9q4_comp_1")),
                difficulty: Some("easy".into()), cognitive_level: Some("remembering".into()), choices: vec![],
                answer_key: AnswerKeySpec { acceptable_answers: vec!["Exposition".into()] }, },
            QuestionSpec { id: qid("eng_q4_quiz1", 4), question_type: "essay".into(),
                ...
                points: 5, order: 4, is_multi_select: false, tos_competency_id: Some(compid("e9q4_comp_0")),
    ...
    assessments.push(AssessmentSpec {
        ...
        questions: vec![
            QuestionSpec { id: qid("eng_q4_quiz2", 0), question_type: "multiple_choice".into(),
                ...
                points: 1, order: 0, is_multi_select: false, tos_competency_id: Some(compid("e9q4_comp_2")),
                difficulty: Some("medium".into()), cognitive_level: Some("remembering".into()),
                choices: mc_choices("eng_q4_quiz2_q0", 1),
                answer_key: AnswerKeySpec { acceptable_answers: vec!["B".into()] }, },
            QuestionSpec { id: qid("eng_q4_quiz2", 1), question_type: "multiple_choice".into(),
                text: "What is the purpose of a critical review?".into(),
                points: 1, order: 1, is_multi_select: false, tos_competency_id: Some(compid("e9q4_comp_3")),
                difficulty: Some("medium".into()), cognitive_level: Some("understanding".into()),
                choices: mc_choices("eng_q4_quiz2_q1", 0),
                answer_key: AnswerKeySpec { acceptable_answers: vec!["A".into()] }, },
            QuestionSpec { id: qid("eng_q4_quiz2", 2), question_type: "identification".into(),
            ...
            QuestionSpec { id: qid("eng_q4_quiz2", 3), question_type: "identification".into(),
                text: "Which criticism approach examines the text's historical context?".into(),
                points: 1, order: 3, is_multi_select: false, tos_competency_id: Some(compid("e9q4_comp_2")),
            ...
            QuestionSpec { id: qid("eng_q4_quiz2", 4), question_type: "essay".into(),
                ...
                points: 5, order: 4, is_multi_select: false, tos_competency_id: Some(compid("e9q4_comp_3")),
                difficulty: Some("hard".into()), cognitive_level: Some("evaluating".into()), choices: vec![],
                answer_key: AnswerKeySpec { acceptable_answers: vec![] }, },
        ],
    });

    // English 9 - Q4 Quarter Exam
    let eng_q4_exam_qs = build_questions_from_bank("eng_q4_exam",
        &[
        ...
        &[compid("e9q4_comp_0"), compid("e9q4_comp_1"), compid("e9q4_comp_2"), compid("e9q4_comp_3")],
    );
    let eng_q4_exam_points: i32 = eng_q4_exam_qs.iter().map(|q| q.points).sum();
    assessments.push(AssessmentSpec {
        id: aid("eng_q4_exam"), class_id: cid("english_9a"),
        title: "Quarter 4 Exam: English 9".into(),
        description: Some("15-item quarterly assessment on creative writing and literary criticism.".into()),
        time_limit_minutes: 60, open_at: now - chrono::Duration::days(122), close_at: now - chrono::Duration::days(116),
        show_results_immediately: true, total_points: eng_q4_exam_points, component: "quarterly_assessment".into(),
        tos_id: tid("english_9a_tos_q4"), created_at: created, deleted_at: None,
        is_published: true, results_released: true, grading_period_number: 4,
    ...
    assessments.push(AssessmentSpec {
        ...
        questions: vec![
            QuestionSpec { id: qid("sci_q4_quiz1", 0), question_type: "multiple_choice".into(),
                ...
                difficulty: Some("easy".into()), cognitive_level: Some("remembering".into()),
                choices: mc_choices("sci_q4_quiz1_q0", 1),
                answer_key: AnswerKeySpec { acceptable_answers: vec!["B".into()] }, },
            QuestionSpec { id: qid("sci_q4_quiz1", 1), question_type: "multiple_choice".into(),
                text: "What creates a magnetic field around a wire?".into(),
                points: 1, order: 1, is_multi_select: false, tos_competency_id: Some(compid("s9q4_comp_0")),
                difficulty: Some("medium".into()), cognitive_level: Some("understanding".into()),
                choices: mc_choices("sci_q4_quiz1_q1", 0),
                answer_key: AnswerKeySpec { acceptable_answers: vec!["A".into()] }, },
            QuestionSpec { id: qid("sci_q4_quiz1", 2), question_type: "identification".into(),
            ...
            QuestionSpec { id: qid("sci_q4_quiz1", 3), question_type: "identification".into(),
                text: "What is Ohm's law formula?".into(),
                points: 1, order: 3, is_multi_select: false, tos_competency_id: Some(compid("s9q4_comp_0")),
                difficulty: Some("easy".into()), cognitive_level: Some("remembering".into()), choices: vec![],
                answer_key: AnswerKeySpec { acceptable_answers: vec!["V = IR".into()] }, },
            QuestionSpec { id: qid("sci_q4_quiz1", 4), question_type: "essay".into(),
    ...
    assessments.push(AssessmentSpec {
        ...
        questions: vec![
            QuestionSpec { id: qid("sci_q4_quiz2", 0), question_type: "multiple_choice".into(),
                ...
                points: 1, order: 0, is_multi_select: false, tos_competency_id: Some(compid("s9q4_comp_2")),
                difficulty: Some("easy".into()), cognitive_level: Some("remembering".into()),
                choices: mc_choices("sci_q4_quiz2_q0", 0),
                answer_key: AnswerKeySpec { acceptable_answers: vec!["A".into()] }, },
            QuestionSpec { id: qid("sci_q4_quiz2", 1), question_type: "multiple_choice".into(),
                text: "What is the main cause of the enhanced greenhouse effect?".into(),
                points: 1, order: 1, is_multi_select: false, tos_competency_id: Some(compid("s9q4_comp_2")),
                difficulty: Some("medium".into()), cognitive_level: Some("understanding".into()),
                choices: mc_choices("sci_q4_quiz2_q1", 2),
                answer_key: AnswerKeySpec { acceptable_answers: vec!["C".into()] }, },
            QuestionSpec { id: qid("sci_q4_quiz2", 2), question_type: "identification".into(),
                text: "What is the term for the long-term heating of Earth's climate system?".into(),
                points: 1, order: 2, is_multi_select: false, tos_competency_id: Some(compid("s9q4_comp_2")),
                difficulty: Some("easy".into()), cognitive_level: Some("remembering".into()), choices: vec![],
                answer_key: AnswerKeySpec { acceptable_answers: vec!["Global warming".into()] }, },
            QuestionSpec { id: qid("sci_q4_quiz2", 3), question_type: "identification".into(),
                text: "Which gas is most responsible for the natural greenhouse effect?".into(),
                points: 1, order: 3, is_multi_select: false, tos_competency_id: Some(compid("s9q4_comp_2")),
                difficulty: Some("medium".into()), cognitive_level: Some("remembering".into()), choices: vec![],
                answer_key: AnswerKeySpec { acceptable_answers: vec!["Water vapor".into()] }, },
            QuestionSpec { id: qid("sci_q4_quiz2", 4), question_type: "essay".into(),
                text: "Propose three specific actions that students can take to help mitigate climate change in their daily lives.".into(),
                points: 5, order: 4, is_multi_select: false, tos_competency_id: Some(compid("s9q4_comp_3")),
                difficulty: Some("hard".into()), cognitive_level: Some("evaluating".into()), choices: vec![],
                answer_key: AnswerKeySpec { acceptable_answers: vec![] }, },
        ],
    });

    // Science 9 - Q4 Quarter Exam
    let sci_q4_exam_qs = build_questions_from_bank("sci_q4_exam",
        &[
        ...
        &[compid("s9q4_comp_0"), compid("s9q4_comp_1"), compid("s9q4_comp_2"), compid("s9q4_comp_3")],
    );
    let sci_q4_exam_points: i32 = sci_q4_exam_qs.iter().map(|q| q.points).sum();
    assessments.push(AssessmentSpec {
        id: aid("sci_q4_exam"), class_id: cid("science_9a"),
        title: "Quarter 4 Exam: Science 9".into(),
        description: Some("15-item quarterly assessment on electricity, magnetism, and climate change.".into()),
        time_limit_minutes: 60, open_at: now - chrono::Duration::days(123), close_at: now - chrono::Duration::days(117),
        show_results_immediately: true, total_points: sci_q4_exam_points, component: "quarterly_assessment".into(),
        tos_id: tid("science_9a_tos_q4"), created_at: created, deleted_at: None,
        is_published: true, results_released: true, grading_period_number: 4,
    ...
    assessments.push(AssessmentSpec {
        ...
        questions: vec![
            QuestionSpec { id: qid("adv_q4_quiz1", 0), question_type: "multiple_choice".into(),
                ...
                difficulty: Some("easy".into()), cognitive_level: Some("remembering".into()),
                choices: mc_choices("adv_q4_quiz1_q0", 1),
                answer_key: AnswerKeySpec { acceptable_answers: vec!["B".into()] }, },
            QuestionSpec { id: qid("adv_q4_quiz1", 1), question_type: "multiple_choice".into(),
                ...
                difficulty: Some("medium".into()), cognitive_level: Some("understanding".into()),
                choices: mc_choices("adv_q4_quiz1_q1", 0),
                answer_key: AnswerKeySpec { acceptable_answers: vec!["A".into()] }, },
            QuestionSpec { id: qid("adv_q4_quiz1", 2), question_type: "identification".into(),
            ...
            QuestionSpec { id: qid("adv_q4_quiz1", 3), question_type: "identification".into(),
            ...
            QuestionSpec { id: qid("adv_q4_quiz1", 4), question_type: "essay".into(),
