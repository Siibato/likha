...
pub fn demo_tos() -> Vec<TosSpec> {
    vec![
        ...
        TosSpec {
            ...
            class_id: cid("sci10"),
            term_number: 1,
            title: "TOS for Science 10 - T1".into(),
        ...
        TosSpec {
            ...
            class_id: cid("sci10"),
            term_number: 2,
            title: "TOS for Science 10 - T2".into(),
            template_type: "bloom".into(),
            total_items: 50,
            time_limit_unit: "days".into(),
            ww_percent: 40.0,
        ...
        TosSpec {
            ...
            class_id: cid("sci10"),
            term_number: 3,
            title: "TOS for Science 10 - T3".into(),
            template_type: "bloom".into(),
            total_items: 50,
            time_limit_unit: "days".into(),
            ww_percent: 40.0,
        ...
        TosSpec {
            ...
            class_id: cid("sci10"),
            term_number: 4,
            title: "TOS for Science 10 - T4".into(),
            template_type: "bloom".into(),
            total_items: 50,
            time_limit_unit: "days".into(),
            ww_percent: 40.0,
        ...
        TosSpec {
            ...
            class_id: cid("adv10"),
            term_number: 1,
            title: "TOS for Advisory 10 - T1".into(),
        ...
        TosSpec {
            ...
            class_id: cid("adv10"),
            term_number: 2,
            title: "TOS for Advisory 10 - T2".into(),
            template_type: "difficulty".into(),
            total_items: 20,
            time_limit_unit: "days".into(),
            ww_percent: 50.0,
        ...
        TosSpec {
            ...
            class_id: cid("adv10"),
            term_number: 3,
            title: "TOS for Advisory 10 - T3".into(),
            template_type: "difficulty".into(),
            total_items: 20,
            time_limit_unit: "days".into(),
            ww_percent: 50.0,
        ...
        TosSpec {
            ...
            class_id: cid("adv10"),
            term_number: 4,
            title: "TOS for Advisory 10 - T4".into(),
            template_type: "difficulty".into(),
            total_items: 20,
            time_limit_unit: "days".into(),
            ww_percent: 50.0,
