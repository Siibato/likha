//! Q2 assessments for demo seeding: Genetics & Heredity.
...
pub fn demo_assessments_q2(ctx: &SeedContext) -> Vec<AssessmentSpec> {
    ...
    let now = ctx.now();
    let comps = &[compid("s10q2_comp_0"), compid("s10q2_comp_1"), compid("s10q2_comp_2"), compid("s10q2_comp_3")];

    let quiz1_qs = build_questions("q2_quiz1",
        &[
    ...
    let quiz2_qs = build_questions("q2_quiz2",
        &[
    ...
    let exam_qs = build_questions("q2_exam",
        &[
    ...
    vec![
        AssessmentSpec {
            id: aid("q2_quiz1"), class_id: cid("sci10"),
            title: "Q2 Quiz 1: DNA, Genes, and Protein Synthesis".into(),
            ...
            tos_id: tid("sci10_tos_q2"), created_at: created, deleted_at: None,
            is_published: true, results_released: true, term_number: 2,
            questions: quiz1_qs,
        },
        AssessmentSpec {
            id: aid("q2_quiz2"), class_id: cid("sci10"),
            title: "Q2 Quiz 2: Mendelian Genetics and Evolution".into(),
        ...
        AssessmentSpec {
            id: aid("q2_exam"), class_id: cid("sci10"),
            title: "Q2 Quarter Exam: Genetics and Heredity".into(),
            description: Some("25-item quarterly assessment on DNA, genetics, and evolution.".into()),
