//! Q3 assessments for demo seeding: Chemistry.
...
pub fn demo_assessments_q3(ctx: &SeedContext) -> Vec<AssessmentSpec> {
    ...
    let now = ctx.now();
    let comps = &[compid("s10q3_comp_0"), compid("s10q3_comp_1"), compid("s10q3_comp_2"), compid("s10q3_comp_3")];

    let quiz1_qs = build_questions("q3_quiz1",
        &[
    ...
    let quiz2_qs = build_questions("q3_quiz2",
        &[
    ...
    let exam_qs = build_questions("q3_exam",
        &[
    ...
    vec![
        AssessmentSpec {
            id: aid("q3_quiz1"), class_id: cid("sci10"),
            title: "Q3 Quiz 1: Chemical Bonding".into(),
        ...
        AssessmentSpec {
            id: aid("q3_quiz2"), class_id: cid("sci10"),
            title: "Q3 Quiz 2: Chemical Reactions and Equations".into(),
        ...
        AssessmentSpec {
            id: aid("q3_exam"), class_id: cid("sci10"),
