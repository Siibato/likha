...
fn generate_grade_records(classes: &[crate::seed::specs::ClassSpec]) -> Vec<crate::seed::specs::GradeRecordSpec> {
    ...
    for class in classes {
        ...
        // Create 2 period records per class with 40/40/20 weights
        for period in 1..=2 {
...
fn generate_grade_scores(
    ...
    for assessment in assessments {
        ...
        for &student_idx in &enrolled {
            ...
            let grade_item_id = seed_id("grade_items", &format!("assess_{}_{}", assessment.id, assessment.grading_period_number));
    ...
    for assignment in assignments {
        ...
        for &student_idx in &enrolled {
            ...
            let grade_item_id = seed_id("grade_items", &format!("assign_{}_{}", assignment.id, assignment.grading_period_number));
