...
mod tests {
    ...
    fn health_is_unrestricted() {
        assert_eq!(
            resolve(&Method::GET, "/health"),
            RateLimitPolicy::Unrestricted
        );
        assert_eq!(
            resolve(&Method::GET, "/health/ready"),
            RateLimitPolicy::Unrestricted
        );
        assert_eq!(
            resolve(&Method::GET, "/database-id"),
            RateLimitPolicy::Unrestricted
        );
    }
    ...
    fn setup_is_unrestricted() {
        assert_eq!(
            resolve(&Method::GET, "/setup/verify"),
            RateLimitPolicy::Unrestricted
        );
        assert_eq!(
            resolve(&Method::GET, "/admin/setup/qr"),
            RateLimitPolicy::Unrestricted
        );
    }
    ...
    fn sync_routes_are_generous() {
        assert_eq!(
            resolve(&Method::POST, "/sync/full"),
            RateLimitPolicy::SyncGenerous
        );
        assert_eq!(
            resolve(&Method::POST, "/sync/push"),
            RateLimitPolicy::SyncGenerous
        );
        assert_eq!(
            resolve(&Method::POST, "/sync/deltas"),
            RateLimitPolicy::SyncGenerous
        );
    }
    ...
    fn file_endpoints_use_upload_policy() {
        assert_eq!(
            resolve(&Method::POST, "/materials/123/files"),
            RateLimitPolicy::FileUpload
        );
        assert_eq!(
            resolve(&Method::POST, "/assignment-submissions/123/upload"),
            RateLimitPolicy::FileUpload
        );
        assert_eq!(
            resolve(&Method::GET, "/material-files/abc/download"),
            RateLimitPolicy::FileUpload
        );
        assert_eq!(
            resolve(&Method::DELETE, "/submission-files/abc"),
            RateLimitPolicy::FileUpload
        );
    }
    ...
    fn public_auth_endpoints() {
        assert_eq!(
            resolve(&Method::POST, "/auth/check-username"),
            RateLimitPolicy::PublicStrict
        );
        assert_eq!(
            resolve(&Method::POST, "/auth/activate"),
            RateLimitPolicy::PublicStrict
        );
        assert_eq!(
            resolve(&Method::POST, "/auth/login"),
            RateLimitPolicy::AuthSensitive
        );
        assert_eq!(
            resolve(&Method::POST, "/auth/refresh"),
            RateLimitPolicy::AuthSensitive
        );
    }
    ...
    fn admin_account_endpoints() {
        assert_eq!(
            resolve(&Method::POST, "/auth/accounts"),
            RateLimitPolicy::AdminOperations
        );
        assert_eq!(
            resolve(&Method::GET, "/auth/accounts/123"),
            RateLimitPolicy::AdminOperations
        );
        assert_eq!(
            resolve(&Method::DELETE, "/auth/accounts/123"),
            RateLimitPolicy::AdminOperations
        );
    }
    ...
    fn standard_fallback_by_method() {
        assert_eq!(
            resolve(&Method::GET, "/classes"),
            RateLimitPolicy::StandardRead
        );
        assert_eq!(
            resolve(&Method::GET, "/assessments/123"),
            RateLimitPolicy::StandardRead
        );
        assert_eq!(
            resolve(&Method::POST, "/classes"),
            RateLimitPolicy::StandardWrite
        );
        assert_eq!(
            resolve(&Method::PUT, "/classes/123"),
            RateLimitPolicy::StandardWrite
        );
        assert_eq!(
            resolve(&Method::DELETE, "/classes/123"),
            RateLimitPolicy::StandardWrite
        );
    }
}
