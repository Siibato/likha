...
impl ManifestRepository {
    ...
    pub async fn get_classes_manifest(
        &self,
        class_ids: Vec<Uuid>,
    ) -> crate::utils::AppResult<Vec<ManifestEntry>> {
    ...
    pub async fn get_activity_logs_paginated(
        ...
        log_ids: Vec<Uuid>,
        limit: i64,
    ) -> crate::utils::AppResult<PaginatedRecords> {
    ...
    pub async fn get_student_assignment_submissions_for_assignments(
        ...
        ops::get_student_assignment_submissions_for_assignments(
            &self.db,
            user_id,
            assignment_ids,
            limit,
    ...
    pub async fn get_material_files_for_materials(
        &self,
        material_ids: Vec<Uuid>,
    ) -> crate::utils::AppResult<Vec<Value>> {
    ...
    pub async fn get_grade_items_for_classes(
        &self,
        class_ids: Vec<Uuid>,
    ) -> crate::utils::AppResult<Vec<Value>> {
    ...
    pub async fn get_grade_configs_since(
        &self,
        class_ids: Vec<Uuid>,
        since: NaiveDateTime,
    ) -> crate::utils::AppResult<Vec<Value>> {
    ...
    pub async fn get_grade_item_ids_for_classes(
        &self,
        class_ids: Vec<Uuid>,
    ) -> crate::utils::AppResult<Vec<Uuid>> {
    ...
    pub async fn get_core_values_since(
        &self,
        class_ids: Vec<Uuid>,
        since: NaiveDateTime,
    ) -> crate::utils::AppResult<Vec<Value>> {
