...
use crate::modules::student_records::import_schema::{
    HistoryTypeQuery, ImportRequest,
};
...
const SCHOOL_HISTORY_TEMPLATE_HEADERS: &[&str] = &[
    "username", "full_name", "school_name", "school_id", "grade_level",
    "school_year", "section", "date_from", "date_to", "record_type",
];

const SUBJECTS_TEMPLATE_HEADERS: &[&str] = &[
    "username", "full_name", "school_name", "school_year", "subject_name",
    "subject_group", "term_type", "final_grade", "descriptor",
    "term1_grade", "term2_grade", "term3_grade", "term4_grade",
];

const ATTENDANCE_TEMPLATE_HEADERS: &[&str] = &[
    "username", "full_name", "school_name", "school_year", "month",
    "school_days", "days_present",
];

pub async fn get_history_template(
    ...
    (
        ...
        [
            ...
            (header::CONTENT_DISPOSITION, "attachment; filename=\"history_import_template.csv\""),
        ],
        bytes,
    )
}
