...
use ::entity::{
    answer_key_acceptable_answers, answer_keys, assessment_questions, assessment_submissions,
    assessments, question_choices, submission_answer_items, submission_answers,
};
...
impl AssessmentRepository {
    ...
    pub async fn find_submitted_submissions_by_assessment_id(
        &self,
        assessment_id: Uuid,
    ) -> AppResult<Vec<assessment_submissions::Model>> {
