...
use crate::modules::assessment::handler as assessment_handler;
...
pub fn routes(assessment_service: Arc<AssessmentService>) -> Router {
    Router::new()
        ...
        .route("/questions/{id}", put(assessment_handler::update_question))
        .route(
            "/questions/{id}",
        ...
        .route(
            ...
            get(assessment_handler::get_student_submission),
        )
        .route(
