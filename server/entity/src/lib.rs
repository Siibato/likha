...
pub mod previous_school_term_grades;
...
pub use previous_school_term_grades::Entity as PreviousSchoolTermGrades;
...
pub mod prelude {
    ...
    pub use super::previous_school_term_grades::{self, Entity as PreviousSchoolTermGrades};
    ...
    pub use super::assignments::{self, Entity as Assignments};
