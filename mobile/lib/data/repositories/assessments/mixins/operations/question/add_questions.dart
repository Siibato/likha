...
ResultFuture<List<Question>> addQuestions(
  ...
  try {
    if (!base.serverReachabilityService.isServerReachable) {
      ...
      await base.localDataSource.cacheQuestions(assessmentId, questionModels);
    ...
    final result = await base.remoteDataSource.addQuestions(
      assessmentId: assessmentId,
      questions: questions,
    );
    await base.localDataSource.cacheQuestions(assessmentId, result, isServerConfirmed: true);
    return Right(result);
