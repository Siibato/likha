            ...
            child: Column(
              ...
              children: [
                ...
                if (isLocked) ...[
                  ...
                  Text(
                    'Try again in ${_formatTime(authState.lockoutRemainingSeconds!)}',
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              Text(
                                'Attempt ${5 - authState.attemptsRemaining!}/5 — Invalid password',
                                style: const TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.w600,
                                  color: Color(0xFFDC3545),
                              ...
                              const SizedBox(height: 8),
                              Text(
                                '${authState.attemptsRemaining} attempt(s) remaining',
                                style: const TextStyle(
                                  fontSize: 13,
                                  fontWeight: FontWeight.w500,
                                  color: Color(0xFFDC3545),
