...
class AdminEditClassDesktop extends ConsumerStatefulWidget {
  final ClassEntity classEntity;

  const AdminEditClassDesktop({super.key, required this.classEntity});

  @override
  ConsumerState<AdminEditClassDesktop> createState() =>
      _AdminEditClassDesktopState();
}

class _AdminEditClassDesktopState
    extends ConsumerState<AdminEditClassDesktop> {
