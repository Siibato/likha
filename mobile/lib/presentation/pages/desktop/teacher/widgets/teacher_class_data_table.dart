...
class TeacherClassDataTable extends StatefulWidget {
  final List<ClassEntity> classes;
  final ValueChanged<ClassEntity> onTap;
  final int rowsPerPage;

  const TeacherClassDataTable({
    super.key,
  ...
  @override
  State<TeacherClassDataTable> createState() => _TeacherClassDataTableState();
}

class _TeacherClassDataTableState extends State<TeacherClassDataTable> {
  ...
  @override
  void didUpdateWidget(TeacherClassDataTable oldWidget) {
